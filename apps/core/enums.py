...
class AuditEventType(models.TextChoices):
    ...
    COPILOT_UPLOAD_STARTED = "COPILOT_UPLOAD_STARTED", "Copilot Upload Started"
    ...
    COPILOT_CASE_EVIDENCE_LOADED = "COPILOT_CASE_EVIDENCE_LOADED", "Copilot Case Evidence Loaded"
...
class CaseStatus(models.TextChoices):
    ...
    EXTRACTION_IN_PROGRESS = "EXTRACTION_IN_PROGRESS", "Extraction In Progress"
    EXTRACTION_COMPLETED = "EXTRACTION_COMPLETED", "Extraction Completed"
    PENDING_EXTRACTION_APPROVAL = "PENDING_EXTRACTION_APPROVAL", "Pending Extraction Approval"
...
class CaseStageType(models.TextChoices):
    ...
    EXTRACTION_APPROVAL = "EXTRACTION_APPROVAL", "Extraction Approval"
