...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f"    [OK] {inv1.invoice_number} (original + duplicate)"))
        ...
        self.stdout.write(self.style.SUCCESS(
            "\n[OK] Invoice test data seeding complete. "
    ...
    def _flush(self):
        ...
        self.stdout.write(self.style.SUCCESS(
            f"    [OK] Flushed: {inv_count} invoices, {line_count} line items"
        ))
