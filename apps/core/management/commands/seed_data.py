...
def _calc_po_totals(lines):
    """Calculate total_amount and tax_amount from lines."""
    total = sum(l["line_amount"] for l in lines)
...
SAMPLE_INVOICES = [
    ...
    # INV-3: Quantity mismatch – invoicing more than PO
    {
        ...
        "extraction_remarks": "Vendor alias detected. Quantities differ from PO for line 1.",
        "lines": [
    ...
    # INV-5: Low confidence extraction
    {
        "raw_vendor_name": "P.R. Electronics",
        "raw_invoice_number": "PRE/25/10032",
        "raw_invoice_date": "2025-08-01",
        "raw_po_number": "PO-2025-0005",
        "raw_currency": "USD",
        "raw_subtotal": "4190.00",
        "raw_tax_amount": "377.10",
        "raw_total_amount": "4567.10",
        ...
        "normalized_po_number": "PO20250005",
        "currency": "USD",
        "subtotal": Decimal("4190.00"),
        "tax_amount": Decimal("377.10"),
        "total_amount": Decimal("4567.10"),
        "vendor_code": "V-1005",
        "status": "READY_FOR_RECON",
        "extraction_confidence": 0.68,
        "extraction_remarks": "Low confidence. Scanned image quality poor. Some fields uncertain.",
        "lines": [
            {"line_number": 1, "raw_description": "ARM Cortex M4 MCU Board", "raw_quantity": "50", "raw_unit_price": "35.00", "raw_tax_amount": "157.50", "raw_line_amount": "1750.00", "description": "ARM Cortex-M4 Microcontroller Board", "normalized_description": "arm cortex m4 microcontroller board", "quantity": Decimal("50"), "unit_price": Decimal("35.00"), "tax_amount": Decimal("157.50"), "line_amount": Decimal("1750.00"), "extraction_confidence": 0.72},
...
TOOL_DEFINITIONS = [
    {
        ...
        "description": "Retrieve invoice header data by invoice ID.",
        "input_schema": {"type": "object", "properties": {"invoice_id": {"type": "integer"}}, "required": ["invoice_id"]},
        "output_schema": {"type": "object", "properties": {"invoice": {"type": "object"}}},
        "enabled": True,
        "module_path": "apps.tools.registry.tools.get_invoice_by_id",
    },
    {
        "name": "get_invoice_lines",
        "description": "Retrieve all line items for a given invoice.",
        "input_schema": {"type": "object", "properties": {"invoice_id": {"type": "integer"}}, "required": ["invoice_id"]},
        "output_schema": {"type": "object", "properties": {"lines": {"type": "array"}}},
        "enabled": True,
        "module_path": "apps.tools.registry.tools.get_invoice_lines",
    },
    {
        "name": "get_po_by_number",
        "description": "Retrieve purchase order header by PO number.",
        "input_schema": {"type": "object", "properties": {"po_number": {"type": "string"}}, "required": ["po_number"]},
        "output_schema": {"type": "object", "properties": {"purchase_order": {"type": "object"}}},
        "enabled": True,
        "module_path": "apps.tools.registry.tools.get_po_by_number",
    },
    {
        "name": "search_po_candidates",
        "description": "Search for PO candidates by vendor, amount, and date range.",
        "input_schema": {"type": "object", "properties": {"vendor_name": {"type": "string"}, "amount": {"type": "number"}, "date_from": {"type": "string"}, "date_to": {"type": "string"}}},
        "output_schema": {"type": "object", "properties": {"candidates": {"type": "array"}}},
        "enabled": True,
        "module_path": "apps.tools.registry.tools.search_po_candidates",
    },
    {
        "name": "get_po_lines",
        "description": "Retrieve all line items for a given purchase order.",
        "input_schema": {"type": "object", "properties": {"po_id": {"type": "integer"}}, "required": ["po_id"]},
        "output_schema": {"type": "object", "properties": {"lines": {"type": "array"}}},
        "enabled": True,
        "module_path": "apps.tools.registry.tools.get_po_lines",
    },
    {
        "name": "get_grns_for_po",
        "description": "Retrieve all GRNs associated with a purchase order.",
        "input_schema": {"type": "object", "properties": {"po_id": {"type": "integer"}}, "required": ["po_id"]},
        "output_schema": {"type": "object", "properties": {"grns": {"type": "array"}}},
        "enabled": True,
        "module_path": "apps.tools.registry.tools.get_grns_for_po",
    },
    {
        "name": "get_grn_lines",
        "description": "Retrieve all line items for a given GRN.",
        "input_schema": {"type": "object", "properties": {"grn_id": {"type": "integer"}}, "required": ["grn_id"]},
        "output_schema": {"type": "object", "properties": {"lines": {"type": "array"}}},
        "enabled": True,
        "module_path": "apps.tools.registry.tools.get_grn_lines",
    },
    {
        "name": "get_vendor_aliases",
        "description": "Retrieve all aliases for a vendor by vendor ID or name.",
        "input_schema": {"type": "object", "properties": {"vendor_id": {"type": "integer"}, "vendor_name": {"type": "string"}}},
        "output_schema": {"type": "object", "properties": {"aliases": {"type": "array"}}},
        "enabled": True,
        "module_path": "apps.tools.registry.tools.get_vendor_aliases",
    },
    {
        "name": "compare_header_evidence",
        "description": "Compare invoice header fields against PO header and return evidence.",
        "input_schema": {"type": "object", "properties": {"invoice_id": {"type": "integer"}, "po_id": {"type": "integer"}}, "required": ["invoice_id", "po_id"]},
        "output_schema": {"type": "object", "properties": {"evidence": {"type": "object"}}},
        "enabled": True,
        "module_path": "apps.tools.registry.tools.compare_header_evidence",
    },
    {
        "name": "compare_line_evidence",
        "description": "Compare invoice lines against PO lines and return line-level evidence.",
        "input_schema": {"type": "object", "properties": {"invoice_id": {"type": "integer"}, "po_id": {"type": "integer"}}, "required": ["invoice_id", "po_id"]},
        "output_schema": {"type": "object", "properties": {"evidence": {"type": "object"}}},
        "enabled": True,
        "module_path": "apps.tools.registry.tools.compare_line_evidence",
    },
    {
        "name": "get_deterministic_reconciliation_result",
        "description": "Retrieve the deterministic reconciliation result for an invoice.",
        ...
        "enabled": True,
        "module_path": "apps.tools.registry.tools.get_deterministic_reconciliation_result",
    },
    {
        "name": "create_review_assignment",
        "description": "Create a new review assignment for a reconciliation result.",
        "input_schema": {"type": "object", "properties": {"result_id": {"type": "integer"}, "priority": {"type": "integer"}, "notes": {"type": "string"}}, "required": ["result_id"]},
        "output_schema": {"type": "object", "properties": {"assignment_id": {"type": "integer"}}},
        "enabled": True,
        "module_path": "apps.tools.registry.tools.create_review_assignment",
    },
    {
        "name": "add_case_note",
        "description": "Add a note to a reconciliation result or review assignment.",
        "input_schema": {"type": "object", "properties": {"result_id": {"type": "integer"}, "note": {"type": "string"}}, "required": ["result_id", "note"]},
        "output_schema": {"type": "object", "properties": {"success": {"type": "boolean"}}},
        "enabled": True,
        "module_path": "apps.tools.registry.tools.add_case_note",
    },
    {
        "name": "save_agent_recommendation",
        "description": "Save an agent recommendation for a reconciliation result.",
        "input_schema": {"type": "object", "properties": {"result_id": {"type": "integer"}, "recommendation_type": {"type": "string"}, "confidence": {"type": "number"}, "reasoning": {"type": "string"}}, "required": ["result_id", "recommendation_type", "confidence", "reasoning"]},
        "output_schema": {"type": "object", "properties": {"recommendation_id": {"type": "integer"}}},
        "enabled": True,
        "module_path": "apps.tools.registry.tools.save_agent_recommendation",
    },
]
    ...
    def handle(self, *args, **options):
        ...
        try:
            with transaction.atomic():
                ...
                if with_invoices or target == "invoices":
                    self._seed_invoices()
