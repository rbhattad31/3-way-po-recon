...
TOOL_PERMISSIONS: Dict[str, str] = {
    ...
    "invoke_exception_analysis_agent": "agents.run_exception_analysis",
    "invoke_reconciliation_assist_agent": "agents.run_reconciliation_assist",
    "invoke_review_routing_agent": "agents.run_review_routing",
    "invoke_case_summary_agent": "agents.run_case_summary",
