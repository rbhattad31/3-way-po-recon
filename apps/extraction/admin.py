...
class ExtractionResultAdmin(admin.ModelAdmin):
    list_display = (
        "id", "document_upload", "extraction_run",
        "engine_name", "engine_version",
        "success_badge", "created_at",
    )
    ...
    fieldsets = (
        ("Links", {
            "fields": ("document_upload", "extraction_run"),
        ...
        ("Tracing", {"fields": ("langfuse_trace_id",), "classes": ("collapse",)}),
...
class ExtractionApprovalAdmin(admin.ModelAdmin):
    list_display = (
        "id", "invoice", "status", "confidence_at_review",
        "is_touchless", "fields_corrected_count",
