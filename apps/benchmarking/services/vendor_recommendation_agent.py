"""Vendor recommendation agent for benchmarking.

Deterministic agent that ranks vendor quotations using market-standard checks:
- overall deviation vs benchmark mid corridor
- variance band distribution (WITHIN_RANGE / MODERATE / HIGH)
- live market reference coverage (citations)
"""
